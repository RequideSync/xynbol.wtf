...
Library.MinSize = if Library.IsMobile then Vector2.new(700, 300) else Vector2.new(700, 450)
...
function Library:SetDPIScale(value: number) 
    ...
    DPIScale = value / 100
    Library.MinSize = (if Library.IsMobile then Vector2.new(700, 300) else Vector2.new(700, 450)) * DPIScale
end
...
function Library:CreateWindow(...)
    ...
    local titleAlign = Enum.TextXAlignment.Left
    local titlePos = UDim2.new(0, 7, 0, 0)
    local titleSize = UDim2.new(0, 0, 0, 25)
    
    if WindowInfo.TitlePos and string.lower(WindowInfo.TitlePos) == "center" then
        titleAlign = Enum.TextXAlignment.Center
        titlePos = UDim2.new(0, 0, 0, 0)
        titleSize = UDim2.new(1, 0, 0, 25)
    end
    ...
    local BottomBarGradFrame = Library:Create("Frame", {
        BackgroundColor3 = Library.AccentColor;
        BorderSizePixel = 0;
    ...
    local BottomBarGradient = Library:Create("UIGradient", {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(150, 150, 150))
        });
        Rotation = 90;
        Parent = BottomBarGradFrame;
    })

    Library:AddToRegistry(BottomBarGradFrame, {
        BackgroundColor3 = "AccentColor";
    })

    local BottomLabel = Library:CreateLabel({
        Position = titlePos + UDim2.new(0, 0, 1, -25);
    ...
    local TabContainerGradient = Library:Create("UIGradient", {
        Color = ColorSequence.new({
